...
const Port_Configtype Port_ConfigArr[PORT_PINS_CONFIG_ARR_SIZE] = {
		...
		//{PORT_PD2 , PORT_LOW , PORT_INPUT, PORT_PULLUP},
		...
		//{PORT_PC4 , PORT_HIGH , PORT_OUTPUT, PORT_FLOATING},
		...
		/* LED GREEN PIN */
		//{PORT_PA4 , PORT_HIGH , PORT_OUTPUT, PORT_FLOATING},

		/* LED BLUE PIN */
		{PORT_PA5 , PORT_LOW , PORT_OUTPUT, PORT_FLOATING},

		/* LED RED PIN */
		//{PORT_PB7 , PORT_HIGH , PORT_OUTPUT, PORT_FLOATING},
